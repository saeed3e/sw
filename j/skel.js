        ...
        It = {
            ...
            initConfig: function (i) {
                ...
                typeof i == E && (i[t] && (It[e][t] = {}), It[M](It[e], i)), It[M](It[J][m].grid, It[e].grid), It[J][m][C] = It[e][C], It[n](It[e][t], function (n) {
                    var i, s = {};
                    It[M](s, It[e][t][n]),
					yt in s || (s[yt] = It[J][m][yt]),
					"range" in s || (s.range = It[J][m].range),
					It[e][t][n] = s, i = {},
					It[M](i, It[J].breakpoint),
					i[e] = It[e][t][n],
					i.test = a(n, i[e].range),
					i[r] = [], It[e].prefix && i[e][yt] !== u && (i[e][yt] = It[e].prefix + "-" + n + ".css"),
					i[e][yt] === "" && (i[e][yt] = u), It[e].preload && i[e][yt] && o[U](i[e][yt]),
					It[t][n] = i,
					It.breakpointList[U](n)
